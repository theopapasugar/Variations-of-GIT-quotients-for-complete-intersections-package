...
# This file was *autogenerated* from the file Monomials.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1)#include imports etc here
...
class Monomial(Original):
    ...
    def monomials(dimension, degree):
        ...
        """
        l = list(WeightedIntegerVectors(degree, [_sage_const_1  for i in range(dimension + _sage_const_1 )]))
